...
namespace Frontend.Authorization
{
    public class AuthenticationAttribute : IAuthenticationFilter
    {
        ...
        public async Task AuthenticateAsync(HttpAuthenticationContext context, CancellationToken cancellationToken)
        {
            ...
            var identity = new AmpluaIdentity(tokenInfo.UserId, true);
            var principal = new AmpluaPrincipal(tokenInfo.Role, identity);
        ...
        {
            Thread.CurrentPrincipal = AmpluaPrincipal.EmptyPrincipal;
        }
