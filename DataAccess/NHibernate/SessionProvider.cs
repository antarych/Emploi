...
namespace DataAccess.NHibernate
{
    public class SessionProvider : ISessionProvider
    {
        ...
        public SessionProvider()
        {
            ...
            modelMapper.AddMapping<VacancyMap>();
            modelMapper.AddMapping<TagMap>();
            modelMapper.AddMapping<OrganizationMap>();
            modelMapper.AddMapping<ContactsMap>();
            modelMapper.AddMapping<ConfirmationRequestMap>();
            modelMapper.AddMapping<MailMap>();
            modelMapper.AddMapping<VacancyTokenMap>();
